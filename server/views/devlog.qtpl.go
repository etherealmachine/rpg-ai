	...
	qw422016.N().S(`
      ...
      <nav aria-label="Development log navigation">
        <ul class="pagination d-flex">
          `)
//line views/devlog.qtpl:53
	if p.Prev != nil {
//line views/devlog.qtpl:53
		qw422016.N().S(`
            <li class="page-item" style="margin-right: auto">
              <a class="page-link" href="`)
//line views/devlog.qtpl:55
...
//line views/devlog.qtpl:79
    ...
    <div>
      ...
      <hr style="width: 100%" />
      `)
//line views/devlog.qtpl:87
	for _, post := range p.Posts {
//line views/devlog.qtpl:87
		qw422016.N().S(`
        <h4>
          <a href="`)
//line views/devlog.qtpl:89
...
//line views/devlog.qtpl:90
		qw422016.E().S(Goment(post.CreatedAt).FromNow())
//line views/devlog.qtpl:90
		qw422016.N().S(`</span>
        </h4>
      `)
//line views/devlog.qtpl:92
	}
//line views/devlog.qtpl:92
	qw422016.N().S(`
    </div>
